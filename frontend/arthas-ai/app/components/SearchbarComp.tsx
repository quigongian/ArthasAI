...
export default function SearchBar({ setSearchSubmitted }: searchBarProps) {
  ...
  return (
    <form className="flex flex-col items-center  mt-40 flex-grow">
      ...
      >
        <div className="flex bg-white rounded-[8px] px-5 py-8 w-full items-center">
          <Search className="h-5 mr-3 text-gray-500" />
          <input
            type="text"
            className="focus:outline-none text-gray-500 flex-grow"
      ...
      <div className="pt-12 flex flex-col items-center">
        <div className="grid grid-cols-3 gap-4">
          <button className="rec-btn">What is AI?</button>
          <button className="rec-btn">A search example here</button>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          ...
          <button className="rec-btn">example can be put here</button>
        </div>
      </div>
    </form>
  );
